  ...
  return (
    <section className="relative overflow-hidden py-8">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(35rem_35rem_at_top_right,rgba(124,58,237,0.05),transparent)]" />
        {/* Playful circles */}
        <div className="absolute top-8 left-1/4 w-2 h-2 rounded-full bg-blue-500/30 animate-pulse" />
        <div className="absolute top-12 left-1/3 w-1.5 h-1.5 rounded-full bg-purple-500/30 animate-pulse delay-150" />
        <div className="absolute top-6 left-2/3 w-2 h-2 rounded-full bg-green-500/30 animate-pulse delay-300" />
      </div>
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="flex items-center gap-3 mb-3">
            <div className="relative">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 flex items-center justify-center text-xl">
                🐰
              </div>
            </div>
          ...
          {/* Stats Pills */}
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.02] border border-white/5 backdrop-blur-sm">
            <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-white/5">
              <span className="text-sm font-medium text-white">5,000</span>
              <span className="text-xs text-gray-400">Rabbits</span>
            </div>
            <div className="w-1 h-1 rounded-full bg-white/10" />
            <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-white/5">
            ...
            <a
              ...
              className="flex items-center gap-2 px-3 py-1 rounded-full hover:bg-white/5 transition-colors group"
            >
              <svg
          ...
          <div className="mt-6 text-center space-y-4">
            <p className="text-gray-400 max-w-xl mx-auto">
              Fluffle Tools is a suite of utilities for Fluffle NFT holders,
              featuring a 3D model viewer, rarity analytics, and PFP generator.
              Explore your Fluffle NFTs in full 3D glory and discover their
              unique traits.
            </p>
            <a
