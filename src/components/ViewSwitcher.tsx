...
export function ViewSwitcher({ activeView, onViewChange }: ViewSwitcherProps) {
  return (
    <>
      {/* Desktop View */}
      <div className="hidden sm:flex items-center gap-2 p-1.5 bg-white dark:bg-white/[0.02] rounded-xl border border-gray-200 dark:border-white/10 shadow-sm backdrop-blur-sm max-w-[calc(100vw-2rem)] mx-auto">
        <button
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-white/10 pb-safe">
