...
export function EcosystemDashboard() {
    ...
    const getCategoryCount = (
        ...
        return projects.filter(
            (project) =>
                ...
                (!showMyVotesOnly || (project.votes && project.votes.userVote !== null)),
        ).length
    }
    ...
    const getUserVotedCount = () => {
        return projects.filter((project) => project.votes && project.votes.userVote !== null).length
    }
    ...
    const filteredProjects = projects
        .filter((project) => {
            ...
            const userVoteMatch = showMyVotesOnly
                ? project.votes && project.votes.userVote !== null
                : true
        ...
        <div className="space-y-12 animate-fade-in">
            ...
            <div className="space-y-8">
                ...
                <FilterControls
                    ...
                    setShowMyVotesOnly={setShowMyVotesOnly}
